  ...
  const setActive = (index) => {
    ...
    if (showcaseImg) {
      ...
      setTimeout(() => {
        ...
        // Encuadre por imagen. El default es 'contain' para que ninguna moto
        // salga recortada; data-fit/data-pos permiten forzar otro encuadre
        // en una foto concreta si hiciera falta.
        showcaseImg.style.objectFit = f.dataset.fit || 'contain';
